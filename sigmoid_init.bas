Attribute VB_Name = "sigmoid_init"
...
Sub Perceptron_1()
    ...
    Dim g As Worksheet
    Set g = ThisWorkbook.Sheets("Feuil2")
    ...
    Next k
        ...
        For k = 2 To 1743
            g.Cells(k, 7) = f.Cells(k + 19, 2) ' on prend les valeurs pour les
...
Sub loss_1()
    ...
    Set g = ThisWorkbook.Sheets("Feuil2")
        ...
        For k = 2 To 1743
            ...
            J1 = -(g.Cells(k, 7) * Log(g.Cells(k, 6)) + (1 - g.Cells(k, 7)) * Log(1 - g.Cells(k, 6)))
            g.Cells(k, 10) = J1
...
Sub Prediction_1()
    ...
    For k = 1395 To 1743
        ...
        X1(k - 1393) = g.Cells(k, 1)
        X2(k - 1393) = g.Cells(k, 2)
        X3(k - 1393) = g.Cells(k, 3)
        g.Cells(k - 1393, 32) = g.Cells(k, 9)
